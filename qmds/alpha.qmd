...
Let's use this with some bacteria we found in the Darrington dataset,
based on relative proportions but that has been regenerated to generate
some total counts.
...
A CHAO1 index value of **11.5** means the estimated total species
richness (or number of OTUs/ASVs) in the sample is about 11.5 species.
...
in a sample. Both for species richness and eveness.
...
shannon_log10 <- diversity(bacteria_counts, index = "shannon")
...
very high diversity). So our value of 0.7 would mean there are multiple
species within our sample, but there is uneven distribution as diversity
is not the highest.
...
richness<br> <input type="radio" name="q1" value="c"> C. Only species
...
function checkAnswer1() {
  ...
  if (answer.value === "b") {
    result.textContent = "✅ Correct! Shannon Diversity accounts for both species richness and evenness.";
...
<input type="radio" name="q1" value="a"> A. Species richness, with a
particular focus on rare species<br>
<input type="radio" name="q1" value="b"> B. Measures species
evenness<br> <input type="radio" name="q1" value="c"> C. Measures
genetic diversity within species<br>
<input type="radio" name="q1" value="d"> D. Estimates species turnover
...
function checkAnswer1() {
  ...
  if (answer.value === "a") {
    result.textContent = "✅ Correct! CHAO1 estimates species richness, including unseen rare species.";
    result.style.color = "green";
  } else {
    result.textContent = "❌ Not quite, try again.";
    result.style.color = "red";
