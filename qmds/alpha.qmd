...
```{r echo=FALSE, message=FALSE, out.width="50%", fig.align="center", fig.cap="This image was generated from ChatGPT."}
library(vegan)
...
function checkAnswer2() {
  ...
  if (answer.value === "b") {
    result.textContent = "✅ Correct! Simpsons index does  look for genetic diversity based on species richness and evenness, but with a focus on dominant species.";
    result.style.color = "green";
  } else {
    result.textContent = "❌ Not quite, try again.";
    result.style.color = "red";
...
A. Shannon’s index is calculated only from the number of species, while Simpson’s index is calculated only from the abundance of species. <br>
<input type="radio" name="q4" value="b"> 
B. Simpson's focuses more on dominant species, Shannon's focuses more on rare species <br> 
<input type="radio" name="q4" value="c">
C.  Shannon’s index increases as the number of dominant species increases, while Simpson’s index decreases.<br>
<input type="radio" name="q4" value="d"> 
D. Shannon’s index uses a logarithmic scale, while Simpson’s index uses an exponential scale <br><br>
