...
<input type="radio" name="q2" value="a"> A. The gene is exactly 16,000 base pairs long\
<br>

<input type="radio" name="q2" value="b"> B. 16S refers to the sedimentation coefficient, meaning the rate at which the particle sediments in a centrifugal field\
<br>

<input type="radio" name="q2" value="c"> C. It indicates the gene is found in 16 different bacterial species\
<br>

<input type="radio" name="q2" value="d"> D. It estimates species turnover between microbial communities\
<br><br>
