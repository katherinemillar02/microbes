---
title: "Microbial Sequencing Techniques"
editor: visual
---
...
```{r echo=FALSE, message=FALSE,fig.align="left", fig.cap="Molecular structure of the 30S Subunit, Schluenzen et al. 2000."}
knitr::include_graphics("images/16SrRNA.png")
...
```{r echo=FALSE, out.width="60%", message=FALSE, fig.cap="The forward and reverse primers of the 16S rRNA gene. THis image was generated on Canva."}
...
```{r echo=FALSE,out.width="80%", message=FALSE, fig.cap="The hypervariable (V1-V9), and conserved regions of the 16SrRNA gene. This image was created on Canva."}
...
-   [**V1 - V3**:]{.underline} *27-534 bp* of the 16S gene.\
-   [**V3**:]{.underline} *341-534 bp* of the 16S gene.\
-   [**V3 - V4**:]{.underline} *341-806 bp* of the 16S gene.\
-   [**V4**:]{.underline} *515-806 bp* of the 16S gene.
...
------------------------------------------------------------------------
<!-- Question 1 -->
<p><strong>Which of these is the most common region/s to be used in 16S?</strong></p>

<form id="quiz-form-1">
  <input type="radio" name="q1" value="a"> A. V1<br>
  <input type="radio" name="q1" value="b"> B. V7–8<br>
  <input type="radio" name="q1" value="c"> C. V3–4<br>
  <input type="radio" name="q1" value="d"> D. V7<br><br>
...
function checkAnswer1() {
  ...
  if (answer.value === "c") {
    result.textContent = "✅ Correct! The V3–V4 region is the most commonly sequenced region in 16S studies.";
    result.style.color = "green";
  } else {
    result.textContent = "❌ Not quite. V3–V4 is the most widely used region due to its taxonomic resolution and compatibility with Illumina platforms.";
...
<form id="quiz-form-2">
  <input type="radio" name="q2" value="a"> A. The gene is exactly 16,000 base pairs long<br>
  <input type="radio" name="q2" value="b"> B. 16S refers to the sedimentation coefficient, meaning the rate at which the particle sediments in a centrifugal field<br>
  <input type="radio" name="q2" value="c"> C. It indicates the gene is found in 16 different bacterial species<br>
  <input type="radio" name="q2" value="d"> D. It estimates species turnover between microbial communities<br><br>
...
function checkAnswer2() {
  ...
  if (answer.value === "b") {
    result.textContent = "✅ Correct! The 'S' in 16S refers to Svedberg units, describing sedimentation rate during centrifugation.";
    result.style.color = "green";
  } else {
