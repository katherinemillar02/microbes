...
### Bray-Curtis Dissimilarity, ***BC**~ij~*
...
In Bray-Curtis dissimilarity, the overlap between two samples is measured by summing the **minimum (lower)** values for each species across the two samples. This captures the *shared abundance*—how much both sites have in common—while ignoring excess that exists only in one site. The lower count for each taxon tells you the maximum that can be considered “shared” between the two samples.
...
**A ∩ B** is the number of *shared* species (present in both sites).

  **A ∪ B** is the total number of *unique* species across both sites.
...
-   **Bray-Curtis** → *The quantity of each bacteria matters*
-   **Jaccard** → *Only the presence/absence of each bacteria matters*
...
function checkAnswer1() {
  ...
  if (answer.value === "b") {
    result.textContent = "✅ Correct! Jaccard uses presence/absence, Bray-Curtis uses abundance.";
...
**Both Bray-Curtis and Jaccard use a dissimilarity scale of 0–1. What does this mean?**
...
function checkAnswer2() {
  ...
  if (answer.value === "b") {
    result.textContent = "✅ Correct! A value of 0 means identical, and 1 means completely different.";
    result.style.color = "green";
  } else {
    result.textContent = "❌ Not quite., try again";
    result.style.color = "red";
...
<input type="radio" name="q3" value="a"> A. To invert similarity into dissimilarity<br> <input type="radio" name="q3" value="b"> B. Because the equation calculates diversity directly<br> <input type="radio" name="q3" value="c"> C. To normalize the values between 0 and 1<br> <input type="radio" name="q3" value="d"> D. It’s an arbitrary choice without meaning<br><br>
...
function checkAnswer3() {
  ...
  if (answer.value === "a") {
    result.textContent = "✅ Correct! The '1 -' part inverts similarity measures into a dissimilarity scale.";
    result.style.color = "green";
  } else {
    result.textContent = "❌ Not quite., Try again";
    result.style.color = "red";
...
function checkAnswer5() {
  ...
  if (isNaN(bc) || isNaN(jac)) {
    result.textContent = "⚠️ Please enter numeric answers for both dissimilarities.";
    result.style.color = "orange";
    return;
  }
  ...
  if (isCorrectBC && isCorrectJaccard) {
    result.textContent = "✅ Correct! Bray-Curtis is 0.6 and Jaccard is 0.5";
    result.style.color = "green";
  } else {
    result.textContent = "❌ Not quite. Try checking your calculations again .";
    result.style.color = "red";
  }
}
</script>
...
Su, X., 2021. Elucidating the beta-diversity of the microbiome: from global alignment to local alignment. *Msystems*, *6*(4), pp.10-1128.
