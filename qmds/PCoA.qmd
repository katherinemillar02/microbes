...
fruit_names <- c("Apricot", "Argan", "GF", "Orange", "Peach", "Tangerine") # Label what the fruits are 
...
**What do we see?**
From this we can see that the microbial composition from Argan and Grapefruit are the same. 
